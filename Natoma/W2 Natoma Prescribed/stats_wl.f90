!  programs calcs temp stats
	...
	real temp1(39),nh4n,nox
      ...
      OPEN(UNIT=10,FILE='tsr_1_seg34.csv',status='old')
	do i=1,3
	read(10,*)
	end do
...
!c  subroutine reads data files
      ...
      common /sampdata /daydatacnt,wlqdata,ndata
          ...
          open(25,file='el_obs.csv',status='old')	  
...
!	  7 : ph
	...
	open(99,file='stats_wl.csv',status='unknown')
	write(99,344)
